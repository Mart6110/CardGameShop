...
namespace Plugins.DataStore.InMemory
{
    public class TransactionsInMemoryRepository : ITransactionRepository
    {
        ...
        IEnumerable<Transaction> ITransactionRepository.GetByDayAndCashier(string cashierName, DateTime date)
        {
            throw new NotImplementedException();
        }

        IEnumerable<Transaction> ITransactionRepository.Search(string cashierName, DateTime startDate, DateTime dateTime)
        {
            throw new NotImplementedException();
        }
    }
